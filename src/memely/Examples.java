...
public class Examples {
    ...
    public static void main(String[] args) {
        try {
            showInWindow("one does not simply", oneDoesNotSimply());
            showInWindow("tech support", techSupport());
     ...
     * @return an image that renders the string as text using the default system font, cropped as tightly around
